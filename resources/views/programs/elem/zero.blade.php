...
<p>
	...
	Thank you for checking out the online Bachelor of Science in Elementary Education (ELED) degree program at Mississippi State University (MSU)!  This program is designed to prepare you to have the essential foundations for instructing children in preK-6th grade.
</p>

<p><b>How does the online ELED degree program work?</b></p>
<ul>
	<li><b>In-state tuition for all students.</b></li>
	<li>124 hours are required to complete the program.</li>
	<li>Completely online.</li>
	<li>Two concentrations are available for our ELED curriculum: 1) Early Childhood (PreK-3) and 2) Middle School (K-6).</li>
...
<p>
	If you would like an unofficial transcript evaluation completed before applying, please send an email with your unofficial transcript attached, from all your college course work to <a href="mailto:elemonline@colled.msstate.edu">elemonline@colled.msstate.edu</a>.
</p>
