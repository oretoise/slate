...
@section('content')
<h3>Day 12 - Subject: The “MBA…Your Way”: The Faculty Perspective!</h3>
<p>Dear @@{{First}},</p>
...
<p>
  <i>"The online format has provided a platform to engage students throughout the world and across the United States, leveraging myriad professional talents that have brought a richness to the problems and issues we address in class. We create a sense of community through rigorous discussions. Students submit their thoughts to me, and I can send comments back almost immediately. In the end, meaningful information is shared, problems are solved, and a classroom with a wonderfully human touch emerges."</i>
</p>
