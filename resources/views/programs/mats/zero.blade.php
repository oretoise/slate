...
<p>The 36-hour degree can be completed entirely online. Visit our website to see the types of <a href="http://distance.msstate.edu/mats/courses">courses</a> that are affiliated with this program.</p>

<p><b>It's important to know that the GRE is not required.  Also, if you made at least a 21 on the ACT with no sub score below 18, you are exempt from Praxis Core!</b>  Please visit the <a href="http://distance.msstate.edu/pdf/mats/admissionsChecklist.pdf">admissions checklist</a> for a complete overview of requirements to apply.</p>
