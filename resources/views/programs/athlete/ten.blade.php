...
@section('content')
<h3>Day 10 - Subject: Meet your Athlete Engineering Certificate program team!</h3>
    ...
    <tbody>
        <tr>
            ...
            <td class="divider staff" style="text-align: left;">
                <p>Daphne Knox has been working for the Center for Distance Education at Mississippi State University since 2018.  She coordinates programming for the College of Engineering.</p>
