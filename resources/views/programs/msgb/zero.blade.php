...
<p>After successful completion of the entire two-year program, students will earn a Masters in General Biology. This degree will enable teachers from most states to obtain a higher certification or pay scale and/or an endorsement. Please note that all states have their own criteria for advancement and certification and that there are no educational components to these classes. This degree will not provide students with an initial teaching license. You will need to contact the Department of Education in your state to see how this program relates to state requirements.</p>

<p>The MSGB degree can be earned by completing 33 credit hours of graduate level courses. The program consists of ten (10) content courses that span the different disciplines within biology, including ecology, microbiology, evolutionary biology, and biotechnology, and one (1) on-campus capstone course.  The course schedule for the MSGB program can be accessed <a href="https://online.msstate.edu/msgb#program-structure">here</a>.</p>
